...
export class AbbittScene implements CreateSceneClass {
    ...
    createScene = async (
        ...
        // var camera1 = new BABYLON.ArcRotateCamera("camera1", Math.PI / 2, Math.PI / 4, 30, new BABYLON.Vector3(0, -5, 0), scene);
        var camera1 = new BABYLON.FollowCamera("camera1", new BABYLON.Vector3(0, 0, -20), scene);
        ...
        skyboxMaterial.reflectionTexture = new BABYLON.CubeTexture("Abbitt/textures/skybox2", scene);
        ...
        const texture = new BABYLON.Texture("Abbitt/textures/wood.jpg", scene);
        ...
        // Load hero character
        BABYLON.SceneLoader.ImportMesh("", "./Abbitt/meshes/", "HVGirl.glb", scene, function (newMeshes, particleSystems, skeletons, animationGroups) {
...
export default new AbbittScene();