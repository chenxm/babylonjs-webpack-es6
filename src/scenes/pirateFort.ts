...
export class PirateScene implements CreateSceneClass {
    ...
    createScene = async (
        ...
        const pirateFortImport = await BABYLON.SceneLoader.ImportMeshAsync("", "./pirateFort/", "pirateFort.glb", scene);
        ...
        const cannonImportResult = await BABYLON.SceneLoader.ImportMeshAsync("", "./pirateFort/", "cannon.glb", scene);
        ...
        var cannonBlastSound = new BABYLON.Sound("music", "./pirateFort/cannonBlast.mp3", scene);
